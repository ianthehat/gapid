...
_CLANG_BASE = {
  ...
  "settings": {
    ...
    "cxx_builtin_include_directory": [
      _FULL_PREBUILT+"/lib/gcc/{base}-{host}-{system}/{version}.x/include",
      _FULL_PREBUILT+"/lib/gcc/{base}-{host}-{system}/{version}.x/include-fixed",
      "%sysroot%/usr/include",
    ],
    "cxx_flag": [
      "-std=c++11",
    ...
    "unfiltered_cxx_flag": [
      "-isystem", _FULL_PREBUILT+"/lib/gcc/{base}-{host}-{system}/{version}.x/include",
      "-isystem", _FULL_PREBUILT+"/lib/gcc/{base}-{host}-{system}/{version}.x/include-fixed",
